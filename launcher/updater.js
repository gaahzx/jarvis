...
// ── CONFIG ──
const REPO_OWNER = '__REPO_OWNER__';     // Ex: "gabrielfelipefernandes"
const REPO_NAME = '__REPO_NAME__';       // Ex: "felipe-updates"
const REPO_BRANCH = 'main';
const GITHUB_TOKEN = '__GITHUB_TOKEN__'; // Fine-grained PAT read-only
...
const PROTECTED_PATHS = [
  ...
  // Infraestrutura (nao atualizada via zipball)
  'node_modules',
  'FELIPE-Launcher.exe',
